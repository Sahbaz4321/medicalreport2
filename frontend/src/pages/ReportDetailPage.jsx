...
const ReportDetailPage = () => {
  ...
  const sendChat = async (e) => {
    ...
    try {
      ...
      setMessages((prev) => [...prev, { role: "ai", text: "Error generating answer." }]);
    }
  ...
  return (
    <div className="container py-4">
      ...
      <div className="card shadow-sm p-4 mb-4">
        ...
        <h3 className="fw-bold">{report.fileName}</h3>
      ...
      {/* <div className="card shadow-sm p-4 mb-4">
        ...
        <div className="d-flex align-items-center gap-3">
          ...
          <div>
            <h5 className="fw-bold mb-0">Health Score</h5>
            <small className="text-muted">AI Estimated</small>
          </div>

        </div>

        <div className="display-5 fw-bold mt-3">
          {healthScore}/100
        </div>

        <div className="text-muted">
          Risk Level: <strong>{analysis.riskLevel || "Unknown"}</strong>
        </div>
      ...
      <div className="row g-4">
        ...
        <div className="col-md-6">
          ...
          <div className="card shadow-sm p-4 h-100">
            ...
            <h6 className="fw-bold mb-3">
              <AlertTriangle size={18} /> Detected Conditions
            </h6>
            ...
            {analysis.conditions?.length ? (
              ...
              <p className="text-muted">No conditions detected</p>
            )}
        ...
        <div className="col-md-6">
          ...
          <div className="card shadow-sm p-4 h-100">
            ...
            <h6 className="fw-bold mb-3">
              <Stethoscope size={18} /> Doctor Recommendation
            </h6>

            <p className="text-muted">
              {analysis.doctorRecommendation || "Consult doctor for advice"}
            </p>
      ...
      <div className="row g-4 mt-1">
        ...
        <div className="col-md-6">
          ...
          <div className="card shadow-sm p-4">
            ...
            <h6 className="fw-bold mb-3">
              <TrendingUp size={18} /> Risk Trend
            </h6>

            <RiskTrendChart reports={[report]} />
      ...
      {/* <div className="card shadow-sm p-4 mt-4">
        ...
        >
          ...
          <h6 className="fw-bold mb-0">Extracted OCR Text</h6>

          {ocrOpen ? <ChevronUp/> : <ChevronDown/>}
        ...
        {ocrOpen && (
          <div className="mt-3 text-muted small">
            ...
            {analysis.extractedText || "No OCR text"}
      ...
      {chatOpen && (
        ...
        <div className="chat-window shadow">
          ...
          <div className="chat-body">
            ...
            {chatLoading && <div className="chat-ai">Thinking...</div>}
